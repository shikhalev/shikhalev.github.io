...
Из этих двух посылок, в общем-то, можно вывести текущую картину: никаких специфических концепций мы в нем не увидим, только
...
[cover]: /assets/img/2015-04/136.gif
...
[^context]:  О блоках и замыканиях см. статью «Блоки и контекст в Ruby» в номере 1-2 этого года. <!-- TODO: ссылка -->
[^stdlib]: Подробную документацию на стандартную библиотеку можно найти по адресу <http://rubydoc.info/stdlib/> (англ.)
[^druby]: «Распределенный Ruby» в декабрьском номере 2013 года. <!-- TODO: ссылка -->
