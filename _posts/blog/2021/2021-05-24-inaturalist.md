...
и, на­до полагать, буду упоминать еще. Проект по мно­гим параметрам интересный и значимый. В этом посте я постараюсь рассказать,
как о про­ек­те в це­лом, так и о том, как я лично с ним обращаюсь и что об этом думаю.
...
под свободной лицензией, ее тоже загружать нельзя. Можно загружать чужие фото только непосредственно от име­ни и по по­ру­че­нию
...
**[GBIF][gbif]{:.img-icon-gbif}** допускает лицензии
...
И я весьма рекомендую сразу после регистрации в настройках аккаунта выбрать для себя приемлемую лицензию, чтобы в даль­ней­шем
...
с биологическим все ясно, а что до внеш­не­го, то тут могут быть различия по полу, возрасту, сезону опять же, хорошо видимые на фотографии.
...
нейросетку. Со­от­вет­с­т­вен­но, отпадают все фичи, связанные с сообществом, вместо этого добавляется геймификация и т.д.

Если хотите, чтобы ваш ребенок пропадал одновременно в те­ле­фо­не и в пам­па­сах — это вот оно.
