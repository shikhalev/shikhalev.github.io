...
recommend: true
---
{% image @_src/2019/09/darktable/site.png figure center width=800px crop="1914x1336+0+0"
   caption="Скриншот с [официального сайта Darktable](https://darktable.org)" %}
...
{% image @_src/2019/09/darktable/001.jpg figure center width=800px title="Скриншот обработки" %}
...
{% image @_src/2019/09/darktable/002.png figure left width=340px link=false fig_style="margin-top: 10px;" %}
{% image @_src/2019/09/darktable/003.png figure right width=348px link=false fig_style="margin-top: -5px; margin-bottom: 0px;" %}
...
Как видим, не все модули вообще имеют значок «вкл/выкл» — {% image @_src/2019/09/darktable/004.png width=16px link=false %} —
...
{% image @_src/2019/09/darktable/005.png figure right width=345px link=false %}
...
{% image @_src/2019/09/darktable/006.png figure right width=349px fig_style="margin-top: -5px; margin-bottom: 0px;" link=false %}
...
{% image @_src/2019/09/darktable/006a.png figure left width=340px fig_style="margin-top: 15px;" link=false %}
...
{% image @_src/2019/09/darktable/006b.jpg figure center width=800px %}
...
{% image @_src/2019/09/darktable/007.png figure left width=344px fig_style="margin-bottom: 20px;" link=false %}
...
{% image @_src/2019/09/darktable/008.png figure right width=342px link=false %}
...
(открывается по кнопке {% image @_src/2019/09/darktable/008a.png width=16px link=false %} в заголовке модуля, содержит
...
{% image @_src/2019/09/darktable/008b.png figure center width=349px link=false %}
...
{% image @_src/2019/09/darktable/009.png figure right width=345px link=false %}
...
{% image @_src/2019/09/darktable/010.png figure right width=342px link=false %}
...
{% image @_src/2019/09/darktable/IMG_9341.jpg figure center width=800px %}

Что, правда, ему совершенно не нужно, но в *некоторых* случаях может быть уместно.

### Уровни

{% image @_src/2019/09/darktable/011.png figure right width=343px link=false %}
...
{% image @_src/2019/09/darktable/012a.png figure right width=342px link=false %}
...
{% image @_src/2019/09/darktable/012b.jpg figure center width=800px %}
...
{% image @_src/2019/09/darktable/013.png figure right width=345px link=false %}
...
{% image @_src/2019/09/darktable/sc1.jpg figure center width=800px %}
...
{% image @_src/2019/09/darktable/2002.png figure left width=343px link=false %}
...
На ней мы можем видеть миниатюры наших вариантов, а также две кнопки в заголовке панели: {% image @_src/2019/09/darktable/2002a.png width=16px link=false %}
создает копию XMP-файла, т.е. с текущей историей действий; а {% image @_src/2019/09/darktable/2002b.png width=16px link=false %} —
новый XMP-файл с обработкой по умолчанию.

{% image @_src/2019/09/darktable/2003.png figure right width=342px link=false %}
...
: <p>Опять же речь идет о файлах. Здесь надо отметить следующие особенности: во-первых, Darktable переключается
  ...
  {% image @_src/2019/09/darktable/2004.png figure center width=355px link=false %}
...
{% image @_src/2019/09/darktable/2005.png figure center width=633px %}
...
{% image @_src/2019/09/darktable/2006.png figure right width=294px link=false %}
...
{% image @_src/2019/09/darktable/3001.png figure right width=340px link=false %}
...
{% image @_src/2019/09/darktable/3002.png figure right width=341px link=false %}
...
{% image @_src/2019/09/darktable/3003.png figure left width=301px link=false %}
...
{% image @_src/2019/09/darktable/3004vk.png figure right width=341px link=false %}
...
{% image @_src/2019/09/darktable/3004.png figure left width=194px link=false %}

{% image @_src/2019/09/darktable/3004src.png figure right width=341px link=false %}
