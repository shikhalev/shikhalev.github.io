...
recommend: true
---
{% include image.liquid place="center" width=800 src="/assets/img/2019-09/dtqs/site.jpg"
...
{% include image.liquid width=800 src="/assets/img/2019-09/dtqs/001.jpg" title="Скриншот обработки" %}
...
{% include image.liquid place="left" width=340 src="/assets/img/2019-09/dtqs/002.png" link=false %}
{% include image.liquid place="right" width=348 src="/assets/img/2019-09/dtqs/003.png" link=false %}
...
настройки можно, см. выше про дебайеризацию, например. К ним я потом вкратце еще вернусь, а пока о том, что действительно
требует внимания.

### Ориентация

{% include image.liquid place="right" width=345 src="/assets/img/2019-09/dtqs/005.png" link=false %}
...
{% include image.liquid place="right" width=349 src="/assets/img/2019-09/dtqs/006.png" link=false %}
...
{% include image.liquid place="left" width=340 src="/assets/img/2019-09/dtqs/006a.png" link=false %}
...
{% include image.liquid place="center" width=800 src="/assets/img/2019-09/dtqs/006b.jpg" %}

Раз уж зашла речь о двусторонних картинках, сделаем небольшое отступление от плана.

### Мгновенные снимки

{% include image.liquid place="left" width=344 src="/assets/img/2019-09/dtqs/007.png" link=false style="margin-bottom: 20px;" %}
...
{% include image.liquid place="right" width=342 src="/assets/img/2019-09/dtqs/008.png" link=false %}
...
{% include image.liquid place="center" width=349 src="/assets/img/2019-09/dtqs/008b.png" link=false %}
...
{% include image.liquid place="right" width=345 src="/assets/img/2019-09/dtqs/009.png" link=false %}
...
{% include image.liquid place="right" width=342 src="/assets/img/2019-09/dtqs/010.png" link=false %}
...
{% include image.liquid place="center" width=800 src="/assets/img/2019-09/dtqs/IMG_9341.jpg" %}

Что, правда, ему совершенно не нужно, но в *некоторых* случаях может быть уместно.

### Уровни

{% include image.liquid place="right" width=343 src="/assets/img/2019-09/dtqs/011.png" link=false %}
...
{% include image.liquid place="right" width=342 src="/assets/img/2019-09/dtqs/012a.png" link=false %}
...
{% include image.liquid place="center" width=800 src="/assets/img/2019-09/dtqs/012b.jpg" %}
...
{% include image.liquid place="right" width=345 src="/assets/img/2019-09/dtqs/013.png" link=false %}
...
{% include image.liquid place="center" width=800 src="/assets/img/2019-09/dtqs/sc1.jpg" %}
...
{% include image.liquid place="left" width=343 src="/assets/img/2019-09/dtqs/2002.png" link=false %}
...
{% include image.liquid place="right" width=342 src="/assets/img/2019-09/dtqs/2003.png" link=false %}
...
: <p>Опять же речь идет о файлах. Здесь надо отметить следующие особенности: во-первых, Darktable переключается
  ...
  {% include image.liquid place="center" width=355 src="/assets/img/2019-09/dtqs/2004.png" %}
...
{% include image.liquid place="center" width=633 src="/assets/img/2019-09/dtqs/2005.png" %}
...
{% include image.liquid place="right" width=294 src="/assets/img/2019-09/dtqs/2006.png" link=false %}
...
{% include image.liquid place="right" width=340 src="/assets/img/2019-09/dtqs/3001.png" link=false %}
...
{% include image.liquid place="right" width=341 src="/assets/img/2019-09/dtqs/3002.png" link=false %}
...
{% include image.liquid place="left" width=301 src="/assets/img/2019-09/dtqs/3003.png" link=false %}
...
{% include image.liquid place="right" width=341 src="/assets/img/2019-09/dtqs/3004vk.png" link=false %}
...
{% include image.liquid place="left" width=194 src="/assets/img/2019-09/dtqs/3004.png" link=false %}

{% include image.liquid place="right" width=341 src="/assets/img/2019-09/dtqs/3004src.png" link=false %}
...
{% include image.liquid place="center" width=334 src="/assets/img/2019-09/dtqs/fin.png" link=false %}
